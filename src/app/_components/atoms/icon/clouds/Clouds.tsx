...
export default function Clouds(props: Props) {
  ...
  const cloudFillWidth = Math.min(cloudiness, 100)
  return (
    <div className="relative sort-row-flex justify-center w-24 h-24 ">
      <svg
        className="w-full h-full"
        viewBox="0 0 592.8 592.8"
        xmlns="http://www.w3.org/2000/svg"
      >
        {/* 구름과 내부 배경 전체 */}
        <g>
          <path
            d="M533.6,202.65c1.9-7.7,1.9-13.4,1.9-21c0-53.5-42.1-95.6-95.6-95.6c-36.301,0-66.9,19.1-84.101,47.8
          ...
          <defs>
            <clipPath id="cloud-clip">
              <rect x="0" y="0" width={`${cloudFillWidth}%`} height="100%" />
            </clipPath>
          </defs>
          <path
            d="M533.6,202.65c1.9-7.7,1.9-13.4,1.9-21c0-53.5-42.1-95.6-95.6-95.6c-36.301,0-66.9,19.1-84.101,47.8
            ...
            c7.6-30.6,32.5-51.6,65-51.6c19.101,0,38.2,7.7,49.7,21c7.601-34.4,38.2-59.3,74.601-59.3c42.1,0,76.5,34.4,76.5,76.5
            c0,13.4-3.801,26.8-9.601,38.2h9.601c32.5,0,57.399,24.9,57.399,57.4C573.8,309.65,548.9,334.65,516.4,334.65z"
            fill="#4A5568" // 채워진 구름 색상
            clipPath="url(#cloud-clip)" // 클립 패스를 사용하여 채우기
          />
        </g>
      </svg>
      <span className="absolute font-bold text-lg text-gray-800 left-1/3 -translate-x-1/3 top-1/2">
        {cloudiness}%
      </span>
    </div>
  )
